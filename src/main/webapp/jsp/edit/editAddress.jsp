  ...
  <form method="post" action="home">
    ...
    <div>
      <label class="input">Name:
        <div>
          <input class="input form-control" id="nameInput" placeholder="Enter name" type="text" name="name" value="${requestScope.address.name}">
        </div>
      </label>
    </div>
    <button type="submit" name="command" value="update_address" class="btn btn-default">UPDATE BRAND</button>
    <a href="home?command=read_address" class="btn btn-default">CANCEL</a>
  </form>
</div>
<footer class="footer">
