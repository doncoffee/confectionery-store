...
<div class="wrapper">
    ...
    <div class="main">
        <div class="search-div">
            <form method="get">
                <input type="hidden" name="command" value="read_store">
        ...
        <form action="home" method="get">
            <input type="hidden" name="command" value="go_to_add_store">
            <input type="hidden" name="itemsPerPage" value="${requestScope.itemsPerPage}">
            <input type="hidden" name="currentPage" value="${requestScope.currentPage}">
            <button class="button btn btn-default" type="submit" value="edit">Add store</button>
        </form>
    </div>
