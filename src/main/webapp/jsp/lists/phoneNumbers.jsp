...
<div class="wrapper">
    ...
    <div class="main">
        ...
        <c:otherwise>
            <div>
                <h2 class="catalog-name">There are no phone numbers yet!</h2>
            </div>
        </c:otherwise>
        </c:choose>
            ...
            <div class="pagination">
                <c:if test="${currentPage > 1}">
                    <form method="get" action="home">
                        <input type="hidden" name="command" value="read_phone_number">
        ...
        <form action="home" method="get">
            <input type="hidden" name="command" value="go_to_add_phone_number">
            <input type="hidden" name="itemsPerPage" value="${requestScope.itemsPerPage}">
            <input type="hidden" name="currentPage" value="${requestScope.currentPage}">
            <button class="button btn btn-default" type="submit" value="edit">Add phone number</button>
        </form>
    </div>
