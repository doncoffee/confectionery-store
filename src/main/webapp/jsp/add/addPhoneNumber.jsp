...
<div class="block">
    <h2 class="catalog-name">Add phone number</h2>
    <form method="post" action="home">
        ...
        <div>
            <label class="input">Number:
                <div>
                    <input class="form-control input" id="numberInput" placeholder="Enter number" type="text" name="number">
                </div>
            </label>
        </div>
        <button class="btn btn-default" type="submit" name="command" value="create_phone_number">CREATE PHONE NUMBER</button>
