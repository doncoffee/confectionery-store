...
<div class="block">
    <h2 class="catalog-name">Add cookie</h2>
    <form method="post" action="home">
        <input type="hidden" name="command" value="create_cookie">
        ...
        <button class="btn btn-default" type="submit" name="command" value="create_cookie">CREATE COOKIE</button>
