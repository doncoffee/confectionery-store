...
<div class="block">
    <h2 class="catalog-name">Add brand</h2>
    <form method="post" action="home">
        ...
        <button class="btn btn-default" type="submit" name="command" value="create_brand">CREATE BRAND</button>
        <a class="btn btn-default" href="home?command=read_brand">CANCEL</a>
    </form>
</div>
<footer class="footer">
